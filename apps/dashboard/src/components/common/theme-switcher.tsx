  ...
  return (
    <div className="hidden xl:block">
      <fieldset className="theme-switcher">
        ...
        <div className="flex h-8 items-center rounded-full border bg-background overflow-hidden">
          {options.map(({ value, icon }, index) => (
            <label
              key={value}
              className={cn(
                "relative flex h-8 w-8 cursor-pointer items-center justify-center rounded-full transition-colors duration-200",
                index === 0 && "-ml-[1px]",
