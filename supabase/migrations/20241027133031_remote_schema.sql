alter table "public"."account" drop column "exchange_rate";

alter table "public"."account_history" drop column "exchange_rate";
...
AS $function$BEGIN
    ...
    VALUES (
        ...
        NEW.connection_id, NEW.cost, NEW.quantity, NEW.tax_rate, NEW.ticker
    );
